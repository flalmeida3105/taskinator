...
createTaskEl = function(taskDataObj) {
    ...
    // set a task id as custom attribute
    ...
    // Call saveTasks into localstorage
    saveTasks();
...
editTask = function (taskId) {
    ...
    // present the data into the input fields to be edit.
...
taskStatusChangeHandler = function (event) {
